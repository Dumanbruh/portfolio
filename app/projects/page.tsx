    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-4 my-4 w-full">
                <div className="flex flex-col gap-8 bg-neutral-900 p-4 rounded-md shadow-md">
                ...
                <div className="flex flex-col gap-8 bg-neutral-900 p-4 rounded-md shadow-md">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            <li><a href="https://github.com/Dumanbruh/moscow-pryzki" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/moscow-pryzki</a></li>
                            <li><a href="https://github.com/Dumanbruh/mossport-spartakiada" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/mossport-spartakiada</a></li>
                            <li><a href="https://github.com/Dumanbruh/vdnh-2023" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/vdnh-2023</a></li>
                            <li><a href="https://github.com/Dumanbruh/led-moscow" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/led-moscow</a></li>
                            <li><a href="https://github.com/Dumanbruh/moscow-school-2024" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/moscow-school-2024</a></li>
                            <li><a href="https://github.com/Dumanbruh/moscow-school" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/moscow-school-2023</a></li>
                            <li><a href="https://github.com/zhaxal/moscow-ski" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/zhaxal/moscow-ski</a></li>
                            <li><a href="https://github.com/zhaxal/fizkult-day" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/zhaxal/fizkult-day</a></li>
                        </ul>
                    </div>
                </div>
                <div className="flex flex-col gap-8 bg-neutral-900 p-4 rounded-md shadow-md">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <a href="https://github.com/Dumanbruh/portfolio" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/portfolio</a>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <a href="https://github.com/tickosh" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/tickosh</a>
                    </div>
                </div>
                <div className="flex flex-col gap-8 bg-neutral-900 p-4 rounded-md shadow-md">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <a href="https://github.com/airdex-monitoring" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/airdex-monitoring</a>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <a href="https://github.com/Anime-site" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Anime-site</a>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <a href="https://github.com/Dumanbruh/majestic-sprinters" target="_blank" rel="noopener noreferrer" className='text-blue-500 hover:underline'>https://github.com/Dumanbruh/majestic-sprinters</a>
                    </div>
                </div>
            </div>
        </motion.div>
